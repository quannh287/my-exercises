...
test("estimateMinutes tính thời gian giữ thay cho 40s mặc định", () => {
  // 2 set × (20s nghỉ + 40s giữ) = 120s = 2 phút, thay vì 2 × (20 + 40) mặc định trùng nhau thì đổi số cho khác.
  assert.equal(estimateMinutes(day([{ id: "i", exerciseId: "e", sets: 2, reps: 1, restSec: 20, holdSec: 100 }])), 4);
});
